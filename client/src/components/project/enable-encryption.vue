    ...
    "steps": [
      {
        "introduction": [
          ...
          [
            ...
            "In addition, the following are true in this version of Care Central:",
            [
    ...
    "steps": [
      {
        "introduction": [
          ...
          [
            "Kromě toho platí pro tuto verzi Care Central následující:",
            [
    ...
    "steps": [
      {
        "introduction": [
          ...
          [
            "Außerdem treffen die folgenden Punkte in dieser Version von Care Central zu:",
            [
    ...
    "steps": [
      {
        "introduction": [
          ...
          [
            "Además, lo siguiente es cierto en esta versión de Care Central:",
            [
    ...
    "steps": [
      {
        "introduction": [
          ...
          [
            "En outre, ce qui suit est vrai dans cette version de Care Central :",
            [
    ...
    "steps": [
      {
        "introduction": [
          ...
          [
            "Sebagai tambahan, berikut adalah yang benar ada pada versi Care Central ini:",
            [
    ...
    "steps": [
      {
        "introduction": [
          ...
          [
            "Inoltre, quanto segue è reale in questa versione di Care Central:",
            [
    ...
    "steps": [
      {
        "introduction": [
          ...
          [
            "kwa kuongeza, yafuatayo ni kweli katika toleo hili la Care Central:",
            [
