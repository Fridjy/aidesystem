  ...
  "en": {
    "encryption": {
      ...
      "body": {
        ...
        "encrypted": [
          ...
          "In this version, you may not disable encryption once it is turned on."
        ]
      },
      "action": {
    ...
    "dangerZone": {
      ...
      "archived": [
        ...
        "In this version, you may not unarchive a Project. However, the ability to unarchive a Project is planned for a future release."
      ]
    },
    "alert": {
